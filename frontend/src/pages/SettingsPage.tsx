      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="space-y-1">
          {[
            ...
            <button key={i} className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${item.active ? 'bg-white/10 text-white' : 'text-slate-400 hover:bg-white/5 hover:text-slate-200'}`}>
              {item.icon} {item.label}
            </button>
          ))}
          <div className="pt-4 mt-4 border-t border-white/10">
            <button onClick={logout} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-rose-400 hover:bg-rose-500/10 transition-all">
        ...
        <div className="md:col-span-3 space-y-6">
          <div className="glass-card p-6">
            ...
            <form onSubmit={saveProfile} className="space-y-4">
              ...
              <div>
                <label className="text-xs text-slate-500 mb-1 block">Email Address (Read Only)</label>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
                ...
                <div>
                  <label className="text-xs text-slate-500 mb-1 block">Daily Calorie Goal</label>
